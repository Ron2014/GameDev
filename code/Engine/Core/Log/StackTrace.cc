...
#elif FUTURE_EMSCRIPTEN||FUTURE_ANDROID
#define HAVE_BACKTRACE (0)
...
class FutureStackWalker : public StackWalker {
public:
    ...
    FutureStackWalker(int options) : StackWalker(options) {};
...
void
StackTrace::Dump(char* buf, int bufSize) {
    FutureStackWalker stackWalker(StackWalker::RetrieveSymbol);
